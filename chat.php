...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="chat">
                    <button type="submit" class="btn btn-info">Chat-BOT</button>
    ...
    <div>
    <iframe src='https://webchat.botframework.com/embed/qnamakerforecommerceweb-bot?s=qTP2QhAi6R8.QDex7Y9559nnQKYOLfWi_D32s2vCdrxFJq-tU4rojYk'  style='min-width: 400px; width: 100%; min-height: 500px;'></iframe>
    </div>
